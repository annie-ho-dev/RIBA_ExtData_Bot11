...
'
    With Sheets.Add.Cells(1).CurrentRegion.Resize(, UBound(b, 2))
        .Value = [{"Building Materials & Components Type"," Materials & Components Sub-Type","Imports/Exports","Year","Current Prices (£'000)"}]
